...
public enum ItemErrorCode implements ErrorCode {
    ...
    CATEGORY_WRITE_FORBIDDEN(403, "ITEM_010", "품목 카테고리는 관리자 또는 메인사만 등록/삭제할 수 있습니다."),
    CATEGORY_UPDATE_FORBIDDEN(403, "ITEM_011", "품목 카테고리는 생성한 사용자만 수정할 수 있습니다."),
    ACCESS_DENIED(403, "ITEM_012", "해당 리소스에 접근할 권한이 없습니다."),
    INVALID_ACTOR_HEADER(400, "ITEM_013", "사용자 또는 조직 헤더가 올바르지 않습니다."),
    SUPPLIER_NOT_FOUND(404, "ITEM_014", "로그인한 조직에 연결된 협력사를 찾을 수 없습니다."),
    SUPPLIER_NOT_APPROVED(403, "ITEM_015", "승인된 협력사만 품목을 관리할 수 있습니다."),
    SUPPLIER_NOT_ACTIVE(403, "ITEM_016", "활성 상태의 협력사만 품목을 관리할 수 있습니다."),
